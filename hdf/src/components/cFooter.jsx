        ...
        <CDBBox  justifyContent="between" className="flex-wrap Footer">
          ...
          <CDBBox>
            ...
            <CDBBox  flex="column" style={{ cursor: 'pointer', padding: '0' }}>
             <Link to="/HadafQrup"> <CDBFooterLink className="footertext" href="#">Haqqında</CDBFooterLink></Link>
            <Link to="/services"><CDBFooterLink className="footertext" href="#">Xidmətlər</CDBFooterLink></Link>
            <Link to="/aplicantuseful"><CDBFooterLink className="footertext" href="#">Bloq</CDBFooterLink></Link>
          ...
          <CDBBox>
            ...
            <Link to="/news1"> <CDBFooterLink href="/">Xəbərlər</CDBFooterLink></Link>
             <Link to="/testsubject1"> <CDBFooterLink href="/">Sınaq mövzuları</CDBFooterLink></Link>
          ...
          <CDBBox>
            ...
            <CDBBox className="Footertext" flex="column" style={{ cursor: 'pointer', padding: '0' }}>
           <Link to="/faq"><CDBFooterLink href="#">FAQ</CDBFooterLink></Link>
            <Link to="/ContactForm" ><CDBFooterLink href="#">Əlaqə</CDBFooterLink></Link>
