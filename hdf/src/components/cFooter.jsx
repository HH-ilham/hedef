     ...
     <CDBFooter className="shadow">
      <CDBBox  flex="column" className="Footer mx-auto py-5 " style={{ width: '90%' }}>
        <CDBBox  justifyContent="between" className="flex-wrap Footer">
          ...
          <a className="icon" href="https://twitter.com/intent/user?screen_name=hedefkurslari" target='_blank'>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="25"
              height="25"
          ...
          <a className="icon" href="https://www.instagram.com/accounts/login/?next=/hedef__kurslari/" target='_blank'>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="25"
              height="25"
