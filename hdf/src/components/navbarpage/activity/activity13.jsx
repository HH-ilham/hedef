  ...
  return (
    <div>
      ...
      <p className="container fw-bold">
        Yenicag.az saytı “Azərbaycan Universitetlərinin tanıtımı ” layihəsi
        haqqında yazır…
      </p>
      <p className="container fw-bold">
      ...
      <p className="container">
        <strong>Yeniçağ.Az</strong> xəbər verir ki, layihəni keçirməkdə məqsəd
        Azərbaycan Respublikası ərazisində fəaliyyət göstərən dövlət və özəl
      ...
      <p className="container">
        ...
        tarixinə qədər öz iştiraklarını təsdiq etməlidirlər” – deyə təşkilatdan
        verilən məlumatda bildirilir.
        <br />
      </p>
      <p className="container">
        İstinad : https://goo.gl/BpD7U9
        <br />
        Tarix : 18.05.2017 – 18:05
      </p>{" "}
      <a href="#">
