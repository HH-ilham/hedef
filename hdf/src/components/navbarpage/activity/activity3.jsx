  ...
  return (
    <div>
      ...
      <p className="container">
        Günün səsi qəzeti “Azərbaycan Universitetlərinin tanıtımı” adlı layihə
        haqqında yazır..
      </p>
      <p className="container fw-bold">
        3 iyun 2017-ci il tarixdə Hədəf Kursları Azadlıq filialının sərgi
        zalında Hədəf Globalın təşkilatçılığı ilə Azərbaycan Univeristetlərinin
        sərgisi təşkil olunacaq.
      </p>
      <p className="container">
        Gununsesi.info-nun xəbərinə görə, layihəni keçirməkdə məqsəd Azərbaycan
        Respublikası ərazisində fəaliyyət göstərən dövlət və özəl
        Universitetləri və orta ixtisas məktəblərini abituriyentərə tanıtmaqdır.
      </p>
      <p className="container">
      ...
      <p className="container">
        İştirakçı təhsil müəssisələri və ziyarətçilər sərgidən{" "}
        <strong>ödənişsiz</strong> şəkildə yararlana biləcəklər.
      </p>
      <p className="container">
      ...
      <p className="container">
        İstinad : https://goo.gl/Hp53gX
        <br />
        Tarix : 18 May 2017 – 20:59
        <br />
      </p>{" "}
      <a href="#">
